...
class temperature(object):
  ...
  def string( self, units=None ):
    ...
    if units == "C":
      return "%.1f Celsius" % val
    elif units == "F":
      return "%.1f Fahrenheit" % val
    elif units == "K":
      return "%.1f Kelvin" % val
...
class pressure(object):
  ...
  def string( self, units=None ):
    ...
    val = self.value(units)
    if units == "MB":
      return "%.1f millibar" % val
    elif units == "HPA":
      return "%.1f hektopascal" % val
    elif units == "IN":
...
class speed(object):
  ...
  def string( self, units=None ):
    ...
    val = self.value(units)
    if units == "KMH":
      text = "%.0f kilometers per hour" % val
    elif units == "KT":
      text = "%.0f knots" % val
    elif units == "MPH":
      text = "%.0f miles per hour" % val
    elif units == "MPS":
      text = "%.0f meters per second" % val
    if self._gtlt == ">":
...
class direction(object):
  ...
  compass_dirs = { "North":  0.0, "north-northeast": 22.5, "northeast": 45.0, "east-northeast": 67.5,
